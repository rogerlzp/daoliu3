...
public class MyVisitActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        ((TextView) findViewById(R.id.title)).setText(R.string.my_visit);

        ApplyListFragment tbzListFragment = new ApplyListFragment();
        Bundle b1 = new Bundle();
        b1.putString(LTNConstants.OPERATION_TYPE, LTNConstants.OPERATION_VISIT);
        ...
        mPager.setAdapter(new MyVisitActivity.MyPagerAdapter(getSupportFragmentManager()));
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter implements PagerSlidingTabStrip.IconTabProvider {
        ...
        private final String[] TITLES = {"已查看"};
        ...
        public int getPageTextColor(int position) {
            ...
            if (mPager.getCurrentItem() == position) {
                return ContextCompat.getColor(MyVisitActivity.this, R.color.button_color);
            }
            return 0xff666666;
        }
    }
